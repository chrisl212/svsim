...
package_import_declaration
    : IMPORT package_import_item_list ';'
        { $$ = ast_package_import_declaration_new($2); }
    ;
...
package_import_item
    : ps_identifier
        { $$ = ast_package_import_item_new($1, 0); }
    | ps_identifier_tok TOK_MUL
        { $$ = ast_package_import_item_new(ast_identifier_new($1), 1); }
    ;

package_import_item_list
    : package_import_item_list ',' package_import_item
        { ast_node_list_append((ast_node_list_t *)$1, $3); }
    | package_import_item
...
ps_identifier
    : ps_identifier_tok identifier
        { $$ = ast_ps_identifier_new(ast_identifier_new($1), $2); }
    | '$' UNIT SCOPE identifier
        { $$ = ast_ps_identifier_new(NULL, $4); }
    ;
